...
(function(e) {
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        ...
        build: function(t, n) {
            ...
            e(this.createDivider("秒")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.createDivider("分钟")).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            t || e(this.createDivider("小时", !0)).insertBefore(this.factory.lists[0].$obj);
